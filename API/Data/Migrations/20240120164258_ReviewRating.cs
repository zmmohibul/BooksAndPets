    ...
    public partial class ReviewRating : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductMeasureTypes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthorPictureId = table.Column<int>(type: "integer", nullable: true),
                    Name = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_ProductDepartments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "ProductDepartments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductMeasureOptions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductMeasureOptions_ProductMeasureTypes_MeasureTypeId",
                        column: x => x.MeasureTypeId,
                        principalTable: "ProductMeasureTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    HighlightText = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CategoryProduct_ProductCategories_CategoriesId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MeasureTypeId = table.Column<int>(type: "integer", nullable: false),
                    MeasureOptionId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Price_ProductMeasureOptions_MeasureOptionId",
                        column: x => x.MeasureOptionId,
                        principalTable: "ProductMeasureOptions",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Price_ProductMeasureTypes_MeasureTypeId",
                        column: x => x.MeasureTypeId,
                        principalTable: "ProductMeasureTypes",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MeasureOption = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Price_MeasureOptionId",
                table: "Price",
                column: "MeasureOptionId");

            migrationBuilder.CreateIndex(
                name: "IX_Price_MeasureTypeId",
                table: "Price",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductMeasureOptions_MeasureTypeId",
